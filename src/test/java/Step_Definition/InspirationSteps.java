...
//=================================  Scenario 2  =====================================================================
	...
	public void click_on_where_the_heart_is_option()
	{
	    page.hover2();
	    page.whereHeartIs();
	}
...
//==================================  Scenario 5  ===================================================================
	...
	public void user_click_on_guides_option() 
	{
	    page.hover5();
	    page.clickGuides();
	}
	...
	public void select_nature_of_complaint()
	{
	    page.selectNature();
	}

	@When("User enter their reason for complaint")
	public void user_enter_their_reason_for_complaint(DataTable reason)
	{
...
//==================================  Scenario 6  ===================================================================
	...
	@Then("User is able to click on like icon")//User is able to view the videos in wishlist
	public void user_is_able_to_click_on_like_icon()
	{
		String actual = "";
